...
int main(int argc, char * argv[])
{
	...
	switch(current_options.OP_MODE){
		...
		case 0: 
			...
			init_file(&df); // da far fare solo se si � un modalit� OFFLINE o Server
...
*/
	...
	static struct option long_option[] = {
		  ...
		  {"write-reg-mem",		required_argument, 	0,  	'à' },
		  {"zigbee-rx",			required_argument, 	0,  	'è' },
		  {"read-slot",			required_argument, 	0,  	'ì' },
		  {"modify-parameter",		required_argument, 	0,  	'k' },
		  {"get-parameter",		required_argument, 	0,  	'j' },
		  {"get-interface-name",	no_argument,	 	0,  	'ò' },
		  {"set-tdma-mask",		required_argument,	0,  	'ù' },
